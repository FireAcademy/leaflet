...
require github.com/chia-network/go-chia-libs v0.2.0

require (
	github.com/andybalholm/brotli v1.0.4 // indirect
	github.com/cenkalti/backoff/v4 v4.2.0 // indirect
	github.com/fireacademy/telemetry v0.0.2 // indirect
	github.com/go-logr/logr v1.2.3 // indirect
	github.com/go-logr/stdr v1.2.2 // indirect
	github.com/gofiber/contrib/otelfiber v0.0.0-20230116072133-939d79692a7f // indirect
